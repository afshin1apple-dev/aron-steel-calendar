...
def main():
    ...
    # -----------------------------------------------------
    # FRIDAY
    # جمعه هیچ قیمت کانالی منتشر نمی‌شود
    # -----------------------------------------------------
    if now.weekday() == 4:
        print(
            "Friday - no channel post."
        )
        return
    # -----------------------------------------------------
    # ENV CHECK
    ...
    print(
        f"Factories: "
        f"{len(valid_results)}/{len(CHANNEL_PRODUCTS)}"
    )
    print(
