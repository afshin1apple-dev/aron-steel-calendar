...
def check_publish_time(now):
    ...
    if now.hour != PUBLISH_HOUR:
        ...
        print(
            "IPE is allowed to publish only at 14:00 Iran time."
        )
    ...
    if now.minute > 9:
        ...
        print(
            "IPE scheduled publication window has passed."
        )
...
def check_holiday(now):
    ...
    if now.weekday() == 4:
        ...
        print(
            "No IPE price will be published today."
        )
    ...
    try:
        ...
        print(
            "FAIL SAFE: "
            "No IPE price will be published."
        )
...
def validate_results(results):
    ...
    if actual_sizes != ALLOWED_SIZES:
        ...
        print(
            "ERROR: IPE sizes are incomplete."
        )
